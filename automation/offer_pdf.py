...
def build_offer(path="/app/data_analytics/reports/offer_proplus.pdf"):
    ...
    # Title
    story.append(
        Paragraph("🚀 Automated Finance Reports — Pro+++ Offer", styles["Title"])
    )
    ...
    data = [
        ...
        [
            "Growth",
            "Շաբաթական report (4×), auto email, history tracking",
            "100,000֏/ամիս",
        ],
        [
            "Pro",
            "Ամսական մոնիթորինգ, report + email + mini dashboard, CSV export",
            "150–200,000֏/ամիս",
        ],
    ]
    ...
    story.append(
        Paragraph(
            "📩 Կոնտակտ: your_email@example.com | 📱 +374 XX XXX XXX", styles["Normal"]
        )
    )
